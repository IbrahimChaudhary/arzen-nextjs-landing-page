...
import { jobs, TAG_COLOR_CLASSES } from "@/lib/careers-data";
    ...
    <section id="open-positions" className="bg-[#0a0a0a] px-6 pb-32 pt-16 md:px-12 lg:px-24">
      <div className="mx-auto max-w-5xl">
        ...
        <p className="mt-4 text-base text-gray-400">
          Five roles open right now, all fully remote. See something that fits?
        </p>
        ...
        <div className="mt-12 flex flex-col gap-4">
          {jobs.map((job) => (
            <div
              key={job.slug}
              // Added 'group', changed hover background to a border color transition matching the design
            ...
            >
              ...
              <Link
                ...
                // Added group/btn for nested hover targeting, relative overflow for the gradient fade
