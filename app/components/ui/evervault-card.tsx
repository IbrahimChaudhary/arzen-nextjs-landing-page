...
export function CardPattern({
  ...
  return (
    <div className="pointer-events-none absolute inset-0">
      ...
      <motion.div
        className="absolute inset-0 rounded-2xl bg-gradient-to-r from-[#318f43] via-[#6cc74e] to-[#da909d] opacity-0 backdrop-blur-xl transition duration-500 group-hover/card:opacity-100"
        style={style}
      />
      <motion.div
        className="absolute inset-0 rounded-2xl bg-white/10 opacity-0 backdrop-blur-xl transition duration-500 group-hover/card:opacity-100"
        style={style}
      />
    </div>
  );
